...
// 📊 ოფიციალური GOST / IEC 60228 სტანდარტის მონაცემთა ბაზა (სპილენძი და ალუმინი)
const cableSpecs = {
    copper: {
        ...
        "0.5":  { amperage: { conduit: 6.0, air: 9.0, ground: 11.0 }, price_per_meter: 0.7 },
        "0.75": { amperage: { conduit: 10.0, air: 12.0, ground: 15.0 }, price_per_meter: 1.0 },
        "1.0":  { amperage: { conduit: 14.0, air: 16.0, ground: 19.0 }, price_per_meter: 1.3 },
        "1.5":  { amperage: { conduit: 15.0, air: 19.0, ground: 22.0 }, price_per_meter: 1.8 },
        "2.5":  { amperage: { conduit: 21.0, air: 27.0, ground: 30.0 }, price_per_meter: 2.5 },
        "4.0":  { amperage: { conduit: 27.0, air: 36.0, ground: 40.0 }, price_per_meter: 3.8 },
        "6.0":  { amperage: { conduit: 34.0, air: 46.0, ground: 50.0 }, price_per_meter: 5.5 },
        "10.0": { amperage: { conduit: 50.0, air: 63.0, ground: 70.0 }, price_per_meter: 8.5 },
        "16.0": { amperage: { conduit: 80.0, air: 85.0, ground: 90.0 }, price_per_meter: 13.0 },
        "25.0": { amperage: { conduit: 100.0, air: 115.0, ground: 125.0 }, price_per_meter: 19.0 },
        "35.0": { amperage: { conduit: 135.0, air: 145.0, ground: 155.0 }, price_per_meter: 26.0 },
        "50.0": { amperage: { conduit: 175.0, air: 185.0, ground: 205.0 }, price_per_meter: 35.0 },
        "70.0": { amperage: { conduit: 215.0, air: 235.0, ground: 260.0 }, price_per_meter: 50.0 },
        "95.0": { amperage: { conduit: 260.0, air: 290.0, ground: 320.0 }, price_per_meter: 68.0 },
        "120.0":{ amperage: { conduit: 300.0, air: 335.0, ground: 370.0 }, price_per_meter: 85.0 },
        "150.0":{ amperage: { conduit: 330.0, air: 380.0, ground: 415.0 }, price_per_meter: 105.0 },
        "185.0":{ amperage: { conduit: 500.0, air: 435.0, ground: 475.0 }, price_per_meter: 130.0 },
        "240.0":{ amperage: { conduit: 600.0, air: 520.0, ground: 560.0 }, price_per_meter: 170.0 },
        "300.0":{ amperage: { conduit: 680.0, air: 600.0, ground: 645.0 }, price_per_meter: 210.0 },
        "400.0":{ amperage: { conduit: 800.0, air: 700.0, ground: 750.0 }, price_per_meter: 280.0 }
    },
    aluminum: {
        "0.12": { amperage: { conduit: 1.0, air: 1.5, ground: 2.0 }, price_per_meter: 0.15 },
        "0.2":  { amperage: { conduit: 1.8, air: 2.5, ground: 3.0 }, price_per_meter: 0.2 },
        "0.35": { amperage: { conduit: 3.0, air: 4.2, ground: 5.0 }, price_per_meter: 0.25 },
        "0.5":  { amperage: { conduit: 4.2, air: 6.3, ground: 7.5 }, price_per_meter: 0.35 },
        "0.75": { amperage: { conduit: 7.0, air: 8.5, ground: 10.5 }, price_per_meter: 0.5 },
        "1.0":  { amperage: { conduit: 9.8, air: 11.2, ground: 13.3 }, price_per_meter: 0.65 },
        "1.5":  { amperage: { conduit: 10.0, air: 14.0, ground: 16.0 }, price_per_meter: 0.8 },
        "2.5":  { amperage: { conduit: 16.0, air: 21.0, ground: 23.0 }, price_per_meter: 1.1 },
        "4.0":  { amperage: { conduit: 21.0, air: 28.0, ground: 30.0 }, price_per_meter: 1.6 },
        "6.0":  { amperage: { conduit: 26.0, air: 36.0, ground: 38.0 }, price_per_meter: 2.2 },
        "10.0": { amperage: { conduit: 38.0, air: 50.0, ground: 55.0 }, price_per_meter: 3.5 },
        "16.0": { amperage: { conduit: 55.0, air: 60.0, ground: 65.0 }, price_per_meter: 5.0 },
        "25.0": { amperage: { conduit: 65.0, air: 85.0, ground: 95.0 }, price_per_meter: 7.5 },
        "35.0": { amperage: { conduit: 75.0, air: 105.0, ground: 115.0 }, price_per_meter: 10.0 },
        "50.0": { amperage: { conduit: 105.0, air: 135.0, ground: 150.0 }, price_per_meter: 14.0 },
        "70.0": { amperage: { conduit: 135.0, air: 170.0, ground: 185.0 }, price_per_meter: 19.0 },
        "95.0": { amperage: { conduit: 200.0, air: 210.0, ground: 230.0 }, price_per_meter: 26.0 },
        "120.0":{ amperage: { conduit: 230.0, air: 245.0, ground: 270.0 }, price_per_meter: 33.0 },
        "150.0":{ amperage: { conduit: 255.0, air: 280.0, ground: 305.0 }, price_per_meter: 40.0 },
        "185.0":{ amperage: { conduit: 350.0, air: 320.0, ground: 350.0 }, price_per_meter: 50.0 },
        "240.0":{ amperage: { conduit: 450.0, air: 380.0, ground: 415.0 }, price_per_meter: 65.0 },
        "300.0":{ amperage: { conduit: 500.0, air: 440.0, ground: 475.0 }, price_per_meter: 82.0 },
        "400.0":{ amperage: { conduit: 800.0, air: 700.0, ground: 750.0 }, price_per_meter: 110.0 }
    }
};
